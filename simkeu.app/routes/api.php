...
// Route::prefix('admin')->group(function () {
    ...
    Route::prefix('pengeluaran')->group(function () {
        ...
        Route::delete('/dosen/rekap/{id}/lpj', [LpjController::class, 'dosenDelete'])->middleware($roleTatapMukaWrite);
        ...
        Route::delete('/dosen-kegiatan/rekap/{id}/lpj', [LpjController::class, 'kegiatanDelete'])->middleware($roleKegiatanWrite);
        ...
        Route::delete('/rumah-tangga/rekap/{id}/lpj', [LpjController::class, 'rumahTanggaDelete'])->middleware($roleRumahTanggaWrite);
        ...
        Route::delete('/sarana-prasarana/rekap/{id}/lpj', [LpjController::class, 'saranaPrasaranaDelete'])->middleware($roleSarprasWrite);
        ...
        Route::delete('/transportasi/rekap/{id}/lpj', [LpjController::class, 'transportasiDelete'])->middleware($roleTransportasiWrite);
        ...
        foreach (['bulanan', 'dosen-bulanan'] as $bulananPath) {
            ...
            Route::delete("{$bulananPath}/rekap/{id}/lpj", [LpjController::class, 'dosenBulananDelete'])->middleware($roleBulananWrite);
