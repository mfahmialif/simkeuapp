...
class PengeluaranController extends Controller
{
    ...
    {
        $query = KeuanganSaldoPengeluaran::join('keuangan_saldo', 'keuangan_saldo_pengeluaran.saldo_id', '=', 'keuangan_saldo.id');
        $query->select('keuangan_saldo_pengeluaran.*', 'keuangan_saldo.nama as saldo_nama', 'keuangan_saldo.kode as saldo_kode', 'keuangan_saldo.saldo as saldo_saldo');
