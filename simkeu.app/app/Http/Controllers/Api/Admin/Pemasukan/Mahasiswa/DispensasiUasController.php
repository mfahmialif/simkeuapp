...
use App\Models\KeuanganDispensasiUas;
use App\Http\Controllers\Controller;

use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Validator;

class DispensasiUasController extends Controller
{
    public function index(Request $request)
    {
        $query = KeuanganDispensasiUas::join('users', 'keuangan_dispensasi_uas.user_id', '=', 'users.id')->join('th_akademik', 'keuangan_dispensasi_uas.th_akademik_id', '=', 'th_akademik.id');
        ...
        $query->select('keuangan_dispensasi_uas.*', 'users.name as nama', 'th_akademik.kode as th_akademik');
    ...
    public function store(Request $request)
    {
        ...
        $data = KeuanganDispensasiUas::create([
    ...
    {
        $data = KeuanganDispensasiUas::find($id);
        if (!$data) {
            return response()->json([
                'status' => 'false',
