...
class PembayaranHarianExport implements FromView, WithEvents
{
    ...
    public function __construct($tanggal, $kategori, $prodi, $tahunAkademik, $jenisPembayaran, $includeWisudaSemesterPendek = false)
    {
        $this->prodi = $prodi;
