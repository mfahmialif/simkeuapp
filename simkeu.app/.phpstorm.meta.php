...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\simkeuv2\backend\simkeu.app\public\storage' => 'string',
            'fpdf.orientation' => 'string',
            'fpdf.unit' => 'string',
            'fpdf.size' => 'string',
            'fpdf.font_path' => 'NULL',
            'fpdf.useVaporHeaders' => 'boolean',
            ...
            'simkeu.simkeu_api_key' => 'string',
            'simkeu.simkeu_url' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\simkeuv2\\backend\\simkeu.app\\public\\storage','fpdf.orientation','fpdf.unit',
'fpdf.size','fpdf.font_path','fpdf.useVaporHeaders','logging.default','logging.deprecations.channel',
...
'session.http_only','session.same_site','session.partitioned','simkeu.simkeu_api_key','simkeu.simkeu_url',
...
'sanctum.csrf-cookie',
'dashboard.tableOverview','dashboard.getWidget','kategori.index','kategori.store','kategori.show',
'kategori.update','kategori.destroy','jenis-pembayaran.index','jenis-pembayaran.store','jenis-pembayaran.show',
'jenis-pembayaran.update','jenis-pembayaran.destroy','tagihan.index','tagihan.store','tagihan.show',
'tagihan.update','tagihan.destroy','cek-tagihan.index','cek-tagihan.store','cek-tagihan.show',
'cek-tagihan.update','cek-tagihan.destroy','admin.pemasukan.mahasiswa.kwitansi','admin.pemasukan.mahasiswa.kwitansi.view','pembayaran.index',
'pembayaran.store','pembayaran.show','pembayaran.update','pembayaran.destroy','uas-susulan.index',
'uas-susulan.store','uas-susulan.show','uas-susulan.update','uas-susulan.destroy','setoran.index',
'setoran.store','setoran.show','setoran.update','setoran.destroy','admin.pemasukan.mahasiswa.setoran.validasi',
'admin.pemasukan.mahasiswa.catatan-deposit.nim','catatan-deposit.index','catatan-deposit.store','catatan-deposit.show','catatan-deposit.update',
'catatan-deposit.destroy','pemasukan-pengeluaran.index','pemasukan-pengeluaran.store','pemasukan-pengeluaran.show','pemasukan-pengeluaran.update',
'pemasukan-pengeluaran.destroy','dispensasi.index','dispensasi.store','dispensasi.show',
'dispensasi.update','dispensasi.destroy','dispensasi-tagihan.index','dispensasi-tagihan.store',
'dispensasi-tagihan.show','dispensasi-tagihan.update','dispensasi-tagihan.destroy','dispensasi-uas.index',
'dispensasi-uas.store','dispensasi-uas.show','dispensasi-uas.update','dispensasi-uas.destroy',
'users.index','users.store','users.show','users.update','users.destroy',
'role.index','role.store','role.show','role.update','role.destroy',
'th-akademik.index','th-akademik.store','th-akademik.show','th-akademik.update','th-akademik.destroy',
'prodi.index','prodi.store','prodi.show','prodi.update','prodi.destroy',
'ref.index','ref.store','ref.show','ref.update','ref.destroy','mahasiswa.index','mahasiswa.store','mahasiswa.show',
'mahasiswa.update','mahasiswa.destroy','form-schadule.index','form-schadule.store','form-schadule.show',
'form-schadule.update','form-schadule.destroy','storage.local',);
        registerArgumentsSet('views', 
'admin.mhs-laporan.excel-bulanan','admin.mhs-laporan.excel-harian','admin.mhs-laporan.excel-jumlah-mhs-bayar','admin.mhs-laporan.excel-rekap-tahun','admin.mhs-laporan.excel-tahunan',
'admin.mhs-laporan.excel-totalan-harian','admin.mhs-laporan.index','admin.mhs-laporan.rekap.excel-bulanan','admin.mhs-laporan.rekap.excel-harian','admin.mhs-laporan.rekap.excel-tahunan',
...
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.laragon.www.simkeuv2.backend.simkeu.app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','SIMKEU_URL',
'SIMKEU_API_KEY',);
